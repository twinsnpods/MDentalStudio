...
const Treatments = () => {
  return (
    <div className="bg-white flex flex-col items-center justify-center py-16 px-4">
      ...
      {/* Step 1 */}
      <h1 className="text-black text-5xl sm:text-6xl font-bold ">1. Your First Step</h1>
      ...
      {/* Step 2 */}
      <h1 className="text-black text-5xl sm:text-6xl font-bold mb-20">2. Your Second Step</h1>
      <div className="flex flex-col lg:flex-row gap-12 items-center justify-center mb-16 ml-5">
        <img
          src="boy.png"
          alt="Consultation"
      ...
      {/* Step 3 */}
      <h1 className="text-black text-5xl sm:text-6xl font-bold mb-20 mt-10">3. Third and Final Step</h1>
      <div className="flex flex-col lg:flex-row gap-12 items-center justify-center mb-16">
        <div className="flex-1">
          <h2 className="text-4xl text-black font-bold mb-4 ml-10">Achieve Your Perfect Smile</h2>
          <p className="text-black text-2xl ml-10">
        ...
        <img
          src="streetGirl.png"
          alt="Smile"
          className="w-[450px] h-auto rounded-2xl shadow-2xl mr-5"
        />
      </div>
